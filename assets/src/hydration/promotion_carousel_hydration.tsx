...
export const PromotionCarouselHydration = () =>
    window.addEventListener('DOMContentLoaded', () => {
        const promotionCarousels = document.querySelectorAll(
            '.gymnasium-wellingdorf-promotion-carousel-wrapper'
        );
        if (promotionCarousels !== null) {
            Array.from(promotionCarousels).forEach((promotionCarousel) => {
                ...
                const attributes: PromotionCarouselWrapperProps = JSON.parse(
                    promotionCarousel.getAttribute(
                        'data-gymnasium-wellingdorf-attributes'
                    ) ?? '{}'
                );

                ReactDOM.render(
                    <PromotionCarouselWrapper {...attributes} />,
                    promotionCarousel
                );
            });
        }
